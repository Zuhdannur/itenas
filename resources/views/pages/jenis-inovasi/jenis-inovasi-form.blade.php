...
@section('content')
    <div class="row">
        <div class="col-md-12 col-12">
            @if (empty($data))
                {{ Form::open(['route' => 'jenis-inovasi.store', 'class' => 'form form-vertical', 'id' => 'defaultForm']) }}
            @else
                {{ Form::model($data, ['route' => ['jenis-inovasi.update', $data->id]]) }}
                <input type="text" value="PUT" name="_method" hidden>
            @endif
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Data Jenis Inovasi</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
